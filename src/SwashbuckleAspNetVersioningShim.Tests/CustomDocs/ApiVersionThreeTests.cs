...
namespace SwashbuckleAspNetVersioningShim.Tests.CustomDocs
{
    public class ApiVersionThreeTests : IClassFixture<ApiVersionThreeFixture>
    {
        ...
        public void SwaggerDocumentTitleShouldMatchConfiguredValue()
        {
            ...
            documentTitle.Should().Be("welcome to the documentation for version 3.0 of my api", "because that's what's specified in the Swagger versioning configuration");
        }
    }
}
